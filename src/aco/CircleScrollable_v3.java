 ...
 * @author bishu
 */
public class CircleScrollable_v3 extends javax.swing.JFrame {

    /**
     * Creates new form test
     */
    public CircleScrollable_v3(CirclePane_v3 CP) {
        initComponents(CP);
    ...
    private void initComponents(CirclePane_v3 CirclePanel) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CircleScrollable_v3(new CirclePane_v3()).setVisible(true);
            }
        });
    }
...
class CirclePane_v3 extends JPanel {
