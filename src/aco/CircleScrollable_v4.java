 ...
 * @author bishu
 */
public class CircleScrollable_v4 extends javax.swing.JFrame {

    /**
     * Creates new form test
     */
    public CircleScrollable_v4(CirclePane_v4 CP) {
        initComponents(CP);
        CP.setPreferredSize(new Dimension(1000, CP.n * 50));
    ...
    private void initComponents(CirclePane_v4 CirclePanel) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CircleScrollable_v4(new CirclePane_v4()).setVisible(true);
            }
        });
    }
...
class CirclePane_v4 extends JPanel {
    ...
    public int m[][] = new int[100][100], n, i = 1, j, k;
                ...
                if (m[i][j] == 1) {
                    if (i < j) {
                        ...
                        if (j < k) {
                            ...
                            g.drawLine(c[i].x, c[i].y - 13 - x, c[j].x - 50, c[j].y - 13 - x / 2);
                            drawArrow(g, c[j].x - 50, c[j].y - 13 - x / 2, (j < k) ? (j * 50) : c[j].x - 2, (j < k) ? 63 : (c[j].y + 13 - x));
                        }
                        //drawArrow(g, c[i].x, c[i].y - 13 - x, (j < k) ? (j * 50) : c[j].x, (j < k) ? 63 : (c[j].y + 13 - x));
                    } else {
                        g.drawLine(c[i].x - 8, c[i].y + 13 - x - 2, c[i].x - 100, c[i].y - 13 - x + 15);
                        drawArrow(g, c[i].x - 100, c[i].y - 13 - x + 15, c[i].x - 12, c[i].y - 13 - x + 9);
                    }
                }
            }
